...
import { hiredVehicleIdTypeService } from '../../../services/vehicle_management/hired_vehicle_id_type/hiredVehicleIdTypeService';
import { req, rowsFrom, toBool } from '../../employee_hr_management/shared/hrCrudCommon';

export default function HiredVehicleIdTypePage() {
  ...
  return (
    <CrudEntityPage
      ...
      listFetcher={hiredVehicleIdTypeService.list}
      getByIdFetcher={hiredVehicleIdTypeService.getById}
      createFetcher={hiredVehicleIdTypeService.create}
      updateFetcher={hiredVehicleIdTypeService.update}
      deleteFetcher={hiredVehicleIdTypeService.delete}
      autoSearch
